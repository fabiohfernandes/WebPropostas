#!/usr/bin/env python3
"""
Move shadow section from CommonProperties (Transformação) to IconProperties (Aparência)
"""
...
# First, find and extract the shadow section from CommonProperties
shadow_section = """
      {/* Shadow Controls */}
...
# Remove shadow from CommonProperties
content = content.replace(shadow_section, "")

# Now add shadow section to IconProperties after the Icon Picker section
# Find the end of Icon Picker section
icon_picker_end = """          )}
        </div>
      </div>
    </div>
...
# Replace with icon picker end + shadow section + function end
icon_picker_with_shadow = """          )}
        </div>
      </div>
""" + shadow_section + """
    </div>
...
print("Moved shadow section:")
print("- Removed from CommonProperties (Transformação)")
print("- Added to IconProperties (Aparência)")
print("- Shadow now appears under Ícone picker in Aparência section")
