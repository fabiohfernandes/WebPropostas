#!/usr/bin/env python3
"""
Remove duplicate shadow section from IconProperties
Shadow controls are already in CommonProperties (Transformação section)
"""
...
# Find and remove the entire shadow section from IconProperties
# This is the duplicate - shadow is already in CommonProperties
shadow_section = """
      {/* Shadow Controls */}
...
print("Removed duplicate shadow section from IconProperties")
print("Shadow controls remain in CommonProperties (Transformação section)")
