...
- Click once: opens color dropdown with hex input
...
# Add colorDropdownOpen state back
...
# Replace the color picker section with toggle dropdown
...
print("Color toggle added:")
print("- Click color swatch: opens dropdown with color picker + hex input")
print("- Click again: closes dropdown")
print("- Click outside: closes dropdown")
print("- Espessura slider stays next to color for compact layout")
